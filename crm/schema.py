...
class CreateCustomer(graphene.Mutation):
    ...
    def mutate(self, info, input):
        ...
        if errors:
            return CreateCustomerOutput(errors=errors)
...
class BulkCreateCustomers(graphene.Mutation):
    ...
    def mutate(self, info, input):
        ...
        return BulkCreateCustomersOutput(customers=customers, errors=errors)
...
class CreateProduct(graphene.Mutation):
    ...
    def mutate(self, info, input):
        ...
        if errors:
            return CreateProductOutput(errors=errors)
...
class CreateOrder(graphene.Mutation):
    ...
    def mutate(self, info, input):
        ...
        try:
            ...
            return CreateOrderOutput(errors=errors)
